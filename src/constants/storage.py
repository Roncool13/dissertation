...
RAW_OHLCV_FILENAME = "ohlcv_{timestamp}.parquet"
RAW_NEWS_FILENAME = "news_{timestamp}.parquet"
RAW_CORP_ANN_FILENAME = "corporate_announcements_{timestamp}.parquet"
RAW_FIN_RESULTS_FILENAME = "financial_results_{timestamp}.parquet"

PROCESSED_OHLCV_FILENAME = "ohlcv_{timestamp}.parquet"
PROCESSED_NEWS_FILENAME = "news_{timestamp}.parquet"
PROCESSED_CORP_ANN_FILENAME = "corporate_announcements_{timestamp}.parquet"
PROCESSED_FIN_RESULTS_FILENAME = "financial_results_{timestamp}.parquet"